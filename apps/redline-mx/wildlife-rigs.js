...
export const RIGS = {
  ...
  roadrunner: {
    bones: [
      { name: 'body', at: [0, 0.5, 0], prims: [
        p('ball', '#7a6040', [0, 0, 0], [0.36, 0.2, 0.18]),
        p('ball', '#e4d6b8', [0.08, -0.05, 0], [0.22, 0.12, 0.15]),
        p('box', '#3a3a48', [-0.34, 0.1, 0], [0.42, 0.05, 0.09], [0, 0, 0.45]),
        p('box', '#f2efe6', [-0.53, 0.19, 0], [0.06, 0.055, 0.1], [0, 0, 0.45]),
        p('box', '#4a3a28', [0, 0.02, 0.085], [0.24, 0.06, 0.02]),
        p('box', '#4a3a28', [0, 0.02, -0.085], [0.24, 0.06, 0.02]),
      ] },
      { name: 'head', at: [0.17, 0.62, 0], prims: [
        p('ball', '#6a5238', [0.03, 0.02, 0], [0.13, 0.12, 0.11]),
        p('box', '#2a2a38', [-0.03, 0.1, 0], [0.12, 0.07, 0.05], [0, 0, 0.5]),
  ...
  dog: {
    ...
    pose(a, P) { quadPose(a, P, { stride: 0.9, wag: 0.7, wagSpeed: 16, sitPitch: 0.55 }); },
  },
  ...
  cat: {
    ...
    pose(a, P, t) {
      quadPose(a, P, { stride: 0.8, wag: 0.25, wagSpeed: 2, sitPitch: 0.6 });
  ...
  monkey: {
    bones: [
      { name: 'body', at: [0, 0.55, 0], prims: [
        p('ball', '#6a4226', [0, 0, 0], [0.32, 0.44, 0.28]),
        p('ball', '#d8b088', [0.06, -0.02, 0], [0.2, 0.3, 0.22]),
      ] },
      { name: 'head', at: [0.02, 0.88, 0], prims: [
        p('ball', '#6a4226', [0, 0, 0], [0.3, 0.28, 0.28]),
        p('ball', '#e0bc94', [0.1, -0.03, 0], [0.16, 0.2, 0.22]),
        p('ball', '#e0bc94', [0, 0.01, 0.16], [0.1, 0.12, 0.06]),
        p('ball', '#e0bc94', [0, 0.01, -0.16], [0.1, 0.12, 0.06]),
      ...
      { name: 'armL', at: [0.02, 0.7, 0.17], prims: [
        p('box', '#6a4226', [0, -0.2, 0], [0.08, 0.42, 0.08]),
        p('box', '#d8b088', [0.02, -0.42, 0], [0.08, 0.06, 0.08]),
      ] },
      ...
      { name: 'legL', at: [-0.02, 0.36, 0.09], prims: [
        p('box', '#6a4226', [0, -0.17, 0], [0.09, 0.36, 0.09]),
        p('box', '#d8b088', [0.04, -0.34, 0], [0.14, 0.04, 0.08]),
      ] },
      ...
      { name: 'tail', at: [-0.14, 0.4, 0], prims: [
        p('box', '#6a4226', [-0.16, 0.04, 0], [0.34, 0.05, 0.05], [0, 0, 0.2]),
        p('box', '#6a4226', [-0.34, 0.2, 0], [0.05, 0.3, 0.05], [0, 0, 0.3]),
        p('box', '#6a4226', [-0.26, 0.36, 0], [0.16, 0.05, 0.05], [0, 0, -0.4]),
      ] },
    ],
    pose(a, P, t) {
  ...
  drone: {
    bones: [
      ...
      { name: 'lens', at: [0, 0, 0], glow: true, prims: [p('box', '#40e0ff', [0.225, -0.14, 0], [0.01, 0.08, 0.08])] },
